...
sleepy_artio <- sleepy_artio[sleepy_artio$tips %in% artio_eyes$tips, c("Family", "tips")]
...
# Section 8: One dataframe to rule them all -------------------------------
artio_eyes <- read.csv(here("artio_orbit_ratio.csv"))
...
trait.data <- trait.data[, c("tips", "Body_length", "Dive_depth", "Orbit_ratio", "Echo", "Diet", "Dentition", "FM", "Habitat", "Brain_mass", "Feeding_strategy")]
