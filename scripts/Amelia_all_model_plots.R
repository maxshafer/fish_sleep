...
ER_SYM_results <- readRDS(here("artiodactyla_Cox_max_crep_traits_ER_SYM_models.rds"))
...
#save plot as a PNG
png("C:/Users/ameli/OneDrive/Documents/R_projects/1k_trees/cox_artio_maxcrep_all_models_plot.png", units = "cm", height = 15, width = 15, res = 225)
...
for(i in 1:6){
  png(paste0("C:/Users/ameli/Downloads/rates_dump/artiodactyla_max_crep_ER/rates_plots", i, ".png"), width=20,height=10,units="cm",res=200)
  print(ggplot(rates_df, aes(x= rates, fill = solution)) + geom_histogram() + scale_fill_manual(values = rates_colours)+ scale_x_continuous(trans='log10', labels = trans_format("log10", math_format(10^.x))) + theme_bw() + theme(plot.title = element_blank(), legend.position = "none") + facet_wrap_paginate(~solution, ncol = 1, nrow = 1, page = i))
  dev.off()
}
...
for(i in 1:6){
  png(paste0("C:/Users/ameli/Downloads/rates_dump/artiodactyla_max_crep_SYM/rates_plots", i, ".png"), width=20,height=10,units="cm",res=200)
  print(ggplot(rates_df, aes(x= rates, fill = solution)) + geom_histogram() + scale_fill_manual(values = rates_colours)+ scale_x_continuous(trans='log10', labels = trans_format("log10", math_format(10^.x))) + theme_bw() + theme(plot.title = element_blank(), legend.position = "none") + facet_wrap_paginate(~solution, ncol = 1, nrow = 1, page = i))
  dev.off()
}
...
for(i in 1:6){
  png(paste0("C:/Users/ameli/Downloads/rates_dump/artiodactyla_max_crep_ARD/rates_plots", i, ".png"), width=20,height=10,units="cm",res=200)
  print(ggplot(rates_df, aes(x= rates, fill = solution)) + geom_histogram() + scale_fill_manual(values = rates_colours)+ scale_x_continuous(trans='log10', labels = trans_format("log10", math_format(10^.x))) + theme_bw() + theme(plot.title = element_blank(), legend.position = "none") + facet_wrap_paginate(~solution, ncol = 1, nrow = 1, page = i))
  dev.off()
}
...
for(i in 1:4){
  png(paste0("C:/Users/ameli/Downloads/rates_dump/artiodactyla_max_crep_bridge_only/rates_plots", i, ".png"), width=20,height=10,units="cm",res=200)
  print(ggplot(rates_df, aes(x= rates, fill = solution)) + geom_histogram() + scale_fill_manual(values = rates_colours)+ scale_x_continuous(trans='log10', labels = trans_format("log10", math_format(10^.x))) + theme_bw() + theme(plot.title = element_blank(), legend.position = "none") + facet_wrap_paginate(~solution, ncol = 1, nrow = 1, page = i))
  dev.off()
}
...
ER_SYM_results <- readRDS(here("artiodactyla_Cox_max_dinoc_traits_ER_SYM_models.rds"))
...
#save plot as a PNG
png("C:/Users/ameli/OneDrive/Documents/R_projects/1k_trees/cox_artio_maxdinoc_all_models_plot.png",  units = "cm", height = 15, width = 15, res = 225)
...
for(i in 1:6){
  png(paste0("C:/Users/ameli/Downloads/rates_dump/artiodactyla_max_dinoc_ER/rates_plots", i, ".png"), width=20,height=10,units="cm",res=200)
  print(ggplot(rates_df, aes(x= rates, fill = solution)) + geom_histogram() + scale_fill_manual(values = rates_colours)+ scale_x_continuous(trans='log10', labels = trans_format("log10", math_format(10^.x))) + theme_bw() + theme(plot.title = element_blank(), legend.position = "none") + facet_wrap_paginate(~solution, ncol = 1, nrow = 1, page = i)) 
  dev.off()
}
...
for(i in 1:6){
  png(paste0("C:/Users/ameli/Downloads/rates_dump/artiodactyla_max_dinoc_SYM/rates_plots", i, ".png"), width=20,height=10,units="cm",res=200)
  print(ggplot(rates_df, aes(x= rates, fill = solution)) + geom_histogram() + scale_fill_manual(values = rates_colours)+ scale_x_continuous(trans='log10', labels = trans_format("log10", math_format(10^.x))) + theme_bw() + theme(plot.title = element_blank(), legend.position = "none") + facet_wrap_paginate(~solution, ncol = 1, nrow = 1, page = i))
  dev.off()
}
...
for(i in 1:6){
  png(paste0("C:/Users/ameli/Downloads/rates_dump/artiodactyla_max_dinoc_ARD/rates_plots", i, ".png"), width=20,height=10,units="cm",res=200)
  print(ggplot(rates_df, aes(x= rates, fill = solution)) + geom_histogram() + scale_fill_manual(values = rates_colours)+ scale_x_continuous(trans='log10', labels = trans_format("log10", math_format(10^.x))) + theme_bw() + theme(plot.title = element_blank(), legend.position = "none") + facet_wrap_paginate(~solution, ncol = 1, nrow = 1, page = i))
  dev.off()
}
...
for(i in 1:4){
  png(paste0("C:/Users/ameli/Downloads/rates_dump/artiodactyla_max_dinoc_bridge_only/rates_plots", i, ".png"), width=20,height=10,units="cm",res=200)
  print(ggplot(rates_df, aes(x= rates, fill = solution)) + geom_histogram() + scale_fill_manual(values = rates_colours)+ scale_x_continuous(trans='log10', labels = trans_format("log10", math_format(10^.x))) + theme_bw() + theme(plot.title = element_blank(), legend.position = "none") + facet_wrap_paginate(~solution, ncol = 1, nrow = 1, page = i))
  dev.off()
}
...
# ### Rates Scatterplot Cetacean Max_crep ARD ###----------------------------
...
colnames(rates_pivot) <- c("model", "DiCath", "NocCath", "CathDi", "NocDi", "CathNoc", "DiNoc")

scatter_dinoc <- ggplot(rates_pivot, aes(x = NocDi, y = DiNoc)) + geom_point(colour = "seagreen") +  theme(plot.title = element_text(size = 24), axis.text=element_text(size=24), axis.title=element_text(size=24,face="bold"))

scatter_dicath <- ggplot(rates_pivot, aes(x = CathDi, y = DiCath)) + geom_point(colour = "deeppink") +  theme(plot.title = element_text(size = 24), axis.text=element_text(size=24), axis.title=element_text(size=24,face="bold"))

scatter_noccath <- ggplot(rates_pivot, aes(x = NocCath, y = CathNoc)) + geom_point(colour = "dodgerblue") +  theme(plot.title = element_text(size = 24), axis.text=element_text(size=24), axis.title=element_text(size=24,face="bold"))


#save out as a png
png(filename = "C:/Users/ameli/OneDrive/Documents/R_projects/Rates_scatterplots/cet_max_crep_ARD_scatter_dinoc.png", units = "cm", height = 20, width = 20, res = 500)
scatter_dinoc
dev.off()

png(filename = "C:/Users/ameli/OneDrive/Documents/R_projects/Rates_scatterplots/cet_max_crep_ARD_scatter_dicath.png", units = "cm", height = 20, width = 20, res = 500)
scatter_dicath
dev.off()

png(filename = "C:/Users/ameli/OneDrive/Documents/R_projects/Rates_scatterplots/cet_max_crep_ARD_scatter_noccath.png", units = "cm", height = 20, width = 20, res = 500)
scatter_noccath
dev.off()

# ### Rates Scatterplot Cetacean Max_crep bridge_only ###----------------------------
bridge_only_results <- readRDS(here("cetaceans_tree_max_crep_traits_bridge_only_models.rds"))
...
colnames(rates_pivot) <- c("model", "DiCath", "NocCath", "CathDi", "CathNoc")
...
png(filename = "C:/Users/ameli/OneDrive/Documents/R_projects/Rates_scatterplots/cet_max_crep_bridge_only_scatter_dicath.png", units = "cm", height = 20, width = 20, res = 500)
scatter_dicath
dev.off()

png(filename = "C:/Users/ameli/OneDrive/Documents/R_projects/Rates_scatterplots/cet_max_crep_bridge_only_scatter_noccath.png", units = "cm", height = 20, width = 20, res = 500)
scatter_noccath
dev.off()
...
#save out as a png
png(filename = "C:/Users/ameli/OneDrive/Documents/R_projects/Rates_scatterplots/cet_max_dinoc_ARD_scatter_dinoc.png", units = "cm", height = 20, width = 20, res = 500)
scatter_dinoc
dev.off()

png(filename = "C:/Users/ameli/OneDrive/Documents/R_projects/Rates_scatterplots/cet_max_dinoc_ARD_scatter_dicath.png", units = "cm", height = 20, width = 20, res = 500)
scatter_dicath
dev.off()

png(filename = "C:/Users/ameli/OneDrive/Documents/R_projects/Rates_scatterplots/cet_max_dinoc_ARD_scatter_noccath.png", units = "cm", height = 20, width = 20, res = 500)
scatter_noccath
dev.off()

# ### Rates Scatterplot Cetacean Max_dinoc bridge_only ###----------------------------
bridge_only_results <- readRDS(here("cetaceans_tree_max_dinoc_traits_bridge_only_models.rds"))
...
png(filename = "C:/Users/ameli/OneDrive/Documents/R_projects/Rates_scatterplots/cet_max_dinoc_bridge_only_scatter_dicath.png", units = "cm", height = 20, width = 20, res = 500)
scatter_dicath
dev.off()

png(filename = "C:/Users/ameli/OneDrive/Documents/R_projects/Rates_scatterplots/cet_max_dinoc_bridge_only_scatter_noccath.png", units = "cm", height = 20, width = 20, res = 500)
scatter_noccath
dev.off()
