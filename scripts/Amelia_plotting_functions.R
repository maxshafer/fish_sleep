...
max_clade_metrics <- function(model = readRDS(here("artiodactyla_max_clade_cred_four_state_max_crep_traits_ER_SYM_ARD_models.rds"))) {
...
if(x > 2){
  if(x > 10){
    print("greater than 2, less than 10")
  }
  if(x < 10){
    print("greater than 2, greater than 10")
  }
}
